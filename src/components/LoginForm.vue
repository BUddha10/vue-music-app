<template>
  ...
  <vee-form :validation-schema="loginSchema" @submit="login">
    ...
    <button type="submit" :disable="login_in_submission" class="block w-full bg-purple-600 text-white py-1.5 px-3 rounded transition hover:bg-purple-700">Submit</button>
  </vee-form>
</template>
