  ...
  <div class="border border-gray-200 p-3 mb-4 rounded">
    ...
    <div v-show="showForm">
      ...
      <vee-form :validation-schema="schema" :initial-values="song" @submit="editSong">
        ...
        <button type="submit" class="py-1.5 px-3 mr-2 rounded text-white bg-green-600" :disabled="in_submission">Submit</button>
...
export default {
  ...
  data() {
    return {
      ...
      alert_message: "Please wait! Updading song info",
    };
  },
  methods: {
    async editSong(value) {
      ...
      this.alert_message = "Please wait! Updading song info";

      try {
        const songRef = doc(db, "songs", this.song.docID);
        await updateDoc(songRef, { ...value });
      } catch (error) {
