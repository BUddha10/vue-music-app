...
export { app, auth, createUserWithEmailAndPassword, signInWithEmailAndPassword, db, collection, getDocs, addDoc, doc, setDoc, onAuthStateChanged }; // eslint-disable-line
